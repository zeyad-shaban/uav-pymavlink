...
if __name__ == "__main__":
    ...
    # ! old code focal length was 2.94, in mission planner it is 2.5
    goProHero4Black = Camera(spacingAt100Alt=100.33, focalLength=2.94, imgWidth=40000, imgHeight=3000, sensorWidth=6.17, sensorHeight=4.56)
