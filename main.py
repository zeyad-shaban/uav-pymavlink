...
from missions import start_mission1, start_mission2, start_mission3
...
if __name__ == "__main__":
    ...
    if MISSION_NUMBER == 1:
        start_mission1(uav, master, wpPath=wpPath, fencePath=fencePath, obsPath=obsPath, payloadPath=payloadPath, payloadRadius=10)  # 0 radius means default
    elif MISSION_NUMBER == 2:
        start_mission2(uav, master, wpPath=wpPath, fencePath=fencePath, obsPath=obsPath, camera=sonya6000, surveyAlt=60, surveySpeed=20, surveySquarePath=surveySquare)
    elif MISSION_NUMBER == 3:
        start_mission3(uav, master, wpPath=wpPath, obsPath=obsPath, fencePath=fencePath)
